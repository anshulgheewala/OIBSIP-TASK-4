    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Que2.this, "Your Answer Is Correct", Toast.LENGTH_SHORT).show();
                ...
                Thread thread=new Thread(){
                    ...
                    public void run() {
                        try {
                            ...
                            Toast.makeText(Que2.this, "error", Toast.LENGTH_SHORT).show();
                        }
                        finally {
                            Intent intent=new Intent(Que2.this,Que3.class);
                            int x=12;
        ...
        opt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Que2.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
