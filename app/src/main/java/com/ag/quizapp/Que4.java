    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Que4.this, "Your Answer Is Correct", Toast.LENGTH_SHORT).show();
                ...
                Thread thread=new Thread(){
                    ...
                    public void run() {
                        try {
                            ...
                            Toast.makeText(Que4.this, "error", Toast.LENGTH_SHORT).show();
                        }
                        finally {
                            Intent intent=new Intent(Que4.this,Que5.class);
                            int x=12;
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Que4.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
