    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Que6.this, "Your Answer Is Correct", Toast.LENGTH_SHORT).show();
                ...
                Thread thread=new Thread(){
                    ...
                    public void run() {
                        try {
                            ...
                            Toast.makeText(Que6.this, "error", Toast.LENGTH_SHORT).show();
                        }
                        finally {
                            Intent intent=new Intent(Que6.this,Que7.class);
                            int x=12;
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Que6.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
