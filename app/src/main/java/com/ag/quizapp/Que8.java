    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Que8.this, "Your Answer Is Correct", Toast.LENGTH_SHORT).show();
                ...
                Thread thread=new Thread(){
                    ...
                    public void run() {
                        try {
                            ...
                            Toast.makeText(Que8.this, "error", Toast.LENGTH_SHORT).show();
                        }
                        finally {
                            Intent intent=new Intent(Que8.this,Que9.class);
                            int x=12;
        ...
        opt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Que8.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
