    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        opt3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Que9.this, "Your Answer Is Correct", Toast.LENGTH_SHORT).show();
                ...
                Thread thread=new Thread(){
                    ...
                    public void run() {
                        try {
                            ...
                            Toast.makeText(Que9.this, "error", Toast.LENGTH_SHORT).show();
                        }
                        finally {
                            Intent intent=new Intent(Que9.this,Que10.class);
                            int x=12;
        ...
        opt1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Que9.this, "Wrong Answer", Toast.LENGTH_SHORT).show();
